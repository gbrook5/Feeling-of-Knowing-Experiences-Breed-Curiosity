...
pFolder = fullfile (genFolder, 'subjmm01'); % Change according to who I'm analyzing
data = load (fullfile (pFolder, 'participantresults.txt'));

analysisfolder = fullfile ('C:/Users/gabro/Documents/Graduate Studies/Research/FOK-Restudy Behavioural Study/Numbers', 'subjmm01'); % change for person
...
arrayname = fullfile (analysisfolder, 'numbers_noprimed.txt');
...
tablename = fullfile (analysisfolder, 'numbers_noprimed.xlsx');
